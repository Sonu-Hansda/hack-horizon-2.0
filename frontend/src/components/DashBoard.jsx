...
export default function DashBoard() {
  return (
    <div className="max-w-[1200px] mx-auto space-y-6 lg:space-y-7 pb-8 pt-2 lg:pt-4 fadeIn relative">
      {/* Top Stats Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-6">
        <StatCard icon={PillBottle} value="04" label="Active Medications" badge="ACTIVE" badgeColor="text-[#0E7B62]" />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-6 lg:gap-8">
        ...
        <div className="space-y-4 lg:space-y-5">
          <div className="flex items-center justify-between px-1 lg:px-2">
            ...
            <button className="text-[12px] lg:text-[13px] font-bold text-[#0E7158] hover:text-[#0A5D48] transition-colors tracking-wide">View All Activity</button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-[20px] lg:rounded-[24px] p-6 lg:p-7 shadow-[0_2px_12px_-6px_rgba(0,0,0,0.05)] border border-slate-200/60">
            ...
            <div className="flex justify-between items-end mb-2.5">
              <span className="text-[11px] font-bold text-[#0E7B62] tracking-wider">GOOD STANDINGS</span>
            ...
            <div className="h-1.5 w-full bg-slate-100 rounded-full mb-5 lg:mb-6 overflow-hidden">
              <div className="h-full bg-[#0E7B62] rounded-full" style={{ width: '85%' }}></div>
            </div>
          ...
          <div className="bg-white rounded-[20px] lg:rounded-[24px] p-6 lg:p-7 shadow-[0_2px_12px_-6px_rgba(0,0,0,0.05)] border border-slate-200/60">
            <div className="flex items-center gap-2.5 mb-5 lg:mb-6">
              <div className="w-[3px] h-4 bg-[#0E7B62] rounded-full"></div>
...
// ----------------------------------------------------
// UI COMPONENTS (Dashboard Specific)
// ----------------------------------------------------
  ...
  return (
    <div className={`bg-white rounded-[20px] lg:rounded-[24px] p-5 lg:p-6 shadow-[0_2px_12px_-6px_rgba(0,0,0,0.05)] border border-slate-200/60 flex flex-col justify-between h-[140px] lg:h-[150px] group hover:border-slate-300 transition-colors ${className}`}>
      <div className="flex justify-between items-start">
        <div className={`p-2.5 lg:p-3 rounded-[12px] lg:rounded-[14px] bg-[#F4F7FB] text-slate-400 group-hover:text-[#0E7B62] transition-colors`}>
